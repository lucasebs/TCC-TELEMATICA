...
//                ImageReceiverClient imageReceiverClient = new ImageReceiverClient(input, begin, l);
                ImageReceiverClient imageReceiverClient = new ImageReceiverClient(s, begin, l);
